      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        >
          <div className="bg-white/5 backdrop-blur-xl rounded-3xl p-8 border border-white/10 space-y-8">
            ...
            {/* Service Details */}
            <section>
              <h2 className="text-2xl font-bold text-amber-400 mb-4">Service Details</h2>
              <div className="text-gray-300 space-y-2">
                ...
                <p><strong className="text-white">Total Amount:</strong> ₹1,737 (inclusive of all charges)</p>
              </div>
            </section>

            {/* What's Included */}
            <section>
              <h2 className="text-2xl font-bold text-amber-400 mb-4">What&apos;s Included in Your Ticket</h2>
              <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4">
                <li>Entry to Slanup&apos;s BYOB Diwali Party 2025</li>
                <li>Unlimited food and non-alcoholic beverages</li>
                <li>Entertainment, music, and celebrations</li>
                <li>Mixers, ice, and soft drinks for BYOB setup</li>
                <li>Access to venue facilities</li>
              </ul>
            </section>
            ...
            <section className="bg-red-500/10 border border-red-500/30 rounded-xl p-6">
              ...
              <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4">
                ...
                <li>Being denied entry due to age verification failure (must be 21+)</li>
                <li>Being denied entry due to dress code violation</li>
                <li>Being removed from the event due to misconduct</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <div className="bg-white/5 rounded-xl p-4">
                ...
                <p className="text-white mb-2"><strong>Phone:</strong> +91 81093 51051</p>
