      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        >
          ...
          <div className="bg-white/5 backdrop-blur-xl rounded-3xl p-8 border border-white/10">
            <h2 className="text-2xl font-bold text-amber-400 mb-6">Company Information</h2>
            <div className="space-y-4 text-gray-300">
              <p><strong className="text-white">Business Name:</strong> Slanup</p>
              <p><strong className="text-white">Primary Business:</strong> Social Media Platform for Planning Activities</p>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <motion.div
              ...
              className="bg-white/5 backdrop-blur-xl rounded-2xl p-6 border border-white/10 hover:border-amber-400/50 transition-all"
            >
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 mt-2">
                    For bookings, refunds, and general inquiries
                  </p>
                </div>
              </div>
            </motion.div>
          ...
          {/* Event Details */}
          <div className="bg-gradient-to-r from-amber-400/10 to-amber-600/10 backdrop-blur-xl rounded-3xl p-8 border border-amber-400/30">
            <h2 className="text-2xl font-bold text-amber-400 mb-6">About BYOB Diwali Party 2025</h2>
            <div className="space-y-4 text-gray-300">
              <div>
                <p className="text-white font-semibold mb-1">Event Date:</p>
                <p>October 18, 2025</p>
              </div>
              <div>
                <p className="text-white font-semibold mb-1">Ticket Price:</p>
                <p>₹1,699 per person (+ ₹38 payment gateway fee)</p>
                <p className="text-sm text-gray-400">Total: ₹1,737 inclusive of all charges</p>
              </div>
              <div>
                <p className="text-white font-semibold mb-1">What&apos;s Included:</p>
                <ul className="list-disc list-inside space-y-1 ml-4">
                  <li>Entry to the BYOB Diwali Party</li>
                  <li>Unlimited food and non-alcoholic beverages</li>
                  <li>Entertainment, music, and celebrations</li>
                  <li>Mixers, ice, and soft drinks</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          {/* Support Topics */}
          <div className="bg-white/5 backdrop-blur-xl rounded-3xl p-8 border border-white/10">
            <h2 className="text-2xl font-bold text-amber-400 mb-6">How Can We Help?</h2>
          ...
          {/* CTA */}
          <div className="bg-gradient-to-r from-amber-400 to-amber-600 rounded-3xl p-8 text-center">
        ...
        <div className="text-center mt-12 text-gray-500 text-sm">
          ...
          <div className="flex justify-center gap-6 mt-4">
            <a href="/diwali/terms" className="hover:text-amber-400 transition-colors">Terms & Conditions</a>
            <a href="/diwali/refund-policy" className="hover:text-amber-400 transition-colors">Refund Policy</a>
          </div>
        </div>
      </div>
    </div>
