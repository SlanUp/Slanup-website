...
function PaymentSuccessContent() {
      ...
      try {
        ...
        try {
          ...
          if (verifyData.status === 'failed' || verifyData.status === 'pending') {
            router.push(`/luau/payment/failure?order_id=${orderId}`);
            return;
          }
        } catch (error) {
  ...
  const handleBackToLuau = () => {
    router.push('/luau');
  };

  if (isLoading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-100 to-teal-100 text-neutral-800 flex items-center justify-center">
  ...
  if (error || !booking) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-100 to-teal-100 text-neutral-800 flex items-center justify-center p-4">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-100 to-teal-100 text-neutral-800 relative overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 py-12">
        ...
        >
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-3 animate-bounce text-neutral-800">
            🌺 WUHUUUUU! 🎉🌴
          </h1>
          <p className="text-lg sm:text-xl text-neutral-800 font-semibold">Payment Successful! ✨</p>
        </motion.div>
        ...
        >
          <BookingReference booking={booking} eventConfig={eventConfig || undefined} />
        </motion.div>
